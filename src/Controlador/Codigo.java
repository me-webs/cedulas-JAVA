...
//----------------------  SONIDOS ----------------------------------------//
	...
	public void sonidos () {
		...
		clip.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonido/ding.wav")));
		clip.start();
	...
	public void sonidoCerrar () {
		try{
		clip=AudioSystem.getClip();
		clip.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonido/cerrar.wav")));
		clip.start();
	...
	public void sonidoLimpiar () {
		...
		try{
		clip=AudioSystem.getClip();
		clip.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonido/limpiar.wav")));
		clip.start();
	...
	public void sonidoPasar () {
		...
		try{
		clip=AudioSystem.getClip();
		clip.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonido/pasar.wav")));
		clip.start();
